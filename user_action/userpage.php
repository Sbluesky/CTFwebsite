...
<body class="page-template page-template-contact page-template-contact-php page page-id-217">
	...
	<div class="animload">
		<h2 class="title-vertical title-contact"><span>For U&M</span></h2>
		<section class="contact">
			<div class="container">
				<div class="row">
					<div class="col-xl-6 col-lg-10">
						<div class="text-contact">
							...
							<p>All your information in here!</p>
				...
				<div class="row">
						...
						<div class="col-lg-4 col-md-5 hidden-md-down" style ="margin-top: -150px;">
						...
						<div class="wrap-form">
							<div class="form-styled">
										...
										<form action="logout.php" method="post">
											<button type="submit" class="btn" name="logout" id = "logout" >Log out</button>
