...
if (isset($_POST['register_bt'])) 
  ...
  //function mysqli_real_escape_string delete special character in string
    $_User_Name = mysqli_real_escape_string($db, $_POST['user_name']);
    $_Pass = mysqli_real_escape_string($db, $_POST['passwd']);
   	$_Pass2 = mysqli_real_escape_string($db, $_POST['passwd2']);
