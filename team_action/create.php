...
<head>
	...
	<meta name="title" content="Register a new team">
	<meta name="description" content="Register as a new team." />
...
<body class="page-template page-template-contact page-template-contact-php page page-id-217">
		...
		<div class="menu-menu-1-container"><ul id="menu-menu-1" class="menu">
			<?php
				if(isset($_COOKIE['ID']) OR isset($_SESSION['ID']))
				{
					...
					echo '<li id="menu-item-354" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-354"><a href="teampage.php"><span> Your Team </span></a></li>';
				}
				else 
				{
	...
	<div class="animload">
		<h2 class="title-vertical title-contact"><span>teamf U</span></h2>
		<section class="contact">
			<div class="container">
				<div class="row">
					<div class="col-xl-6 col-lg-10">
						<div class="text-contact">
							...
							<p>Create your team, find your members to prepare for the war.</p>
							<p>Already have a team? <a href="../api/event/read_event.php" class="link">Choose a war you want!</a></p>
							<div class="splash">
				...
				<div class="row">
						...
						<div class="col-lg-4 col-md-5 hidden-md-down" style = "margin-top: -100px; ">
							<img src="../image/hacker9.jpg" alt="" class="img-menu-vertical"  data-bottom-top="transform: translateY(0%);" data-top-bottom="transform: translateY(10%);">
						</div>
					...
					<div class="col-lg-8">
						<div class="wrap-form">
							<div class="form-styled">
										...
										<form action="../api/team/create.php" method="post" class="wpcf7-form" name="register" id="register">

											<label for="">
											<span class="wpcf7-form-control-wrap name"><input type="text" name="team_name" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Team Name" /></span>
											    <strong></strong>
											</label>
											<label for="">
											<span class="wpcf7-form-control-wrap name"><input type="text" name="team_points" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Points" /></span>
											    <strong></strong>
											</label>
											<label for="">
											<?php
											...
											<button class="btn"> <input type="submit" value="Create" name="team_create" id="team_create" ></button>
