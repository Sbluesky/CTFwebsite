<?php
	...
	//Xét xem user có trong team nào không. Nếu không, chuyển tới create.php
	$query = "SELECT * FROM team WHERE idmember1='$ID' OR idmember2='$ID' OR idmember3='$ID' OR idmember4='$ID' OR idmember5='$ID' ";
...
<head>
	...
	<meta name="description" content="Team information." />
...
<body class="page-template page-template-contact page-template-contact-php page page-id-217">
	...
	<div class="animload">
		<h2 class="title-vertical title-contact"><span>For S&T</span></h2>
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-6 col-lg-10">
						<div class="text-contact">
							...
							<p>All your team information in here! </p>
							<p>Goodluck for U.</p>
							<p>If you want to create a new team. <a href="create.php" class="link">Click here!</a></p>
				...
				<div class="row">
						...
						<div class="col-lg-4 col-md-5 hidden-md-down" style="margin-top: -100px;" >
							<img src="../image/hacker8.jpg" alt="" class="img-menu-vertical" data-bottom-top="transform: translateY(0%);" data-top-bottom="transform: translateY(10%);">
						</div>
						...
						<div class="wrap-form">
							<div class="form-styled">
										...
										<?php
											...
											{
												echo "<p> Team name: " . $row["teamname"]. "</p> <br/>";
												echo "<p> Point: " . $row["points"]. "</p> <br/>";
											}
